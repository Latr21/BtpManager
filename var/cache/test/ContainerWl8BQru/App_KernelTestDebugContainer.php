...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\OuvrierController' => 'getOuvrierControllerService',
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Controller\\AffectationController', 'App\\Controller\\ChantierController', 'App\\Controller\\EquipeController', 'App\\Controller\\HomeController', 'App\\Controller\\OuvrierController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['security.csrf.same_origin_token_manager'] = new \Symfony\Component\Security\Csrf\SameOriginCsrfTokenManager(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['logger'] ?? self::getLoggerService($container)), ($container->privates['security.csrf.same_origin_token_manager.inner'] ?? self::getSecurity_Csrf_SameOriginTokenManager_InnerService($container)), ['submit', 'authenticate', 'logout'], false, 'csrf-token');
    }
