 ...
 */
class getOuvrierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OuvrierRepository' shared autowired service.
     *
     * @return \App\Repository\OuvrierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OuvrierRepository.php';

        return $container->privates['App\\Repository\\OuvrierRepository'] = new \App\Repository\OuvrierRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
